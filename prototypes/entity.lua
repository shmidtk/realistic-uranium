...
dtk_uranium_plant.animation = make_4way_animation_from_spritesheet(
            {
              ...
              {
                {
                  filename = "__NuclearShmidtk__/graphics/entity/uranium-refinery/uranium-refinery.png",
                  width = 337,
                  height = 255,
                  frame_count = 1,
                  ...
                  hr_version =
                  {
                    filename = "__NuclearShmidtk__/graphics/entity/uranium-refinery/hr-uranium-refinery.png",
                    width = 386,
                    height = 430,
                    frame_count = 1,
...
dtk_uranium_plant.icon =  "__NuclearShmidtk__/graphics/icons/uranium-refinery.png"
